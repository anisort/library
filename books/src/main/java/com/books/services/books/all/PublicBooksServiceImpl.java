...
@Service
public class PublicBooksServiceImpl implements PublicBooksService {

    private final BooksRepository booksRepository;
    private final UserBooksRepository userBooksRepository;

    @Autowired
    public PublicBooksServiceImpl(BooksRepository booksRepository, UserBooksRepository userBooksRepository) {
